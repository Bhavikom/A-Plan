Ext.define("APlan.model.SchedulerTask", {
    ...
    fields: [
        ...
        { name: 'Number1', type: 'string' },
        { name: 'Number2', type: 'string' },
        { name: 'Number3', type: 'string' },
        { name: 'Number4', type: 'string' },
        { name: 'Number5', type: 'string' },
        { name: 'Number6', type: 'string' },
        { name: 'Number7', type: 'string' },
        { name: 'Number8', type: 'string' },
        { name: 'Number9', type: 'string' },
        { name: 'Number10', type: 'string' },
        ...
        { name: 'EmailTo', type: 'string', dateFormat: 'MS' },
        { name: 'FileName', type: 'string', dateFormat: 'MS' }
    ]
});
