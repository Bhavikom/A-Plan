Ext.define('APlan.Application', {
    extend          : 'Ext.app.Application',
    mixins          : ['Gnt.mixin.Localizable'],
    requires        : [
        'Sch.app.CrudManagerDomain',
        'APlan.locale.En',
        'APlan.store.Calendars',
        'APlan.store.Tasks',
        'APlan.crud.CrudManager',
    ...
    constructor : function (config) {
        /*var me = this;
        var taskStore = new APlan.store.Tasks({
            calendarManager : new APlan.store.Calendars()
        });
        me.crudManager = new APlan.crud.CrudManager({
            taskStore :taskStore
        });
        ...
        AssignCurdManager(taskStore);
        BindExpandEvent(false);
            ...
            case lcRecord && !me.mainView && me.currentLocale != lc:
                ...
                Ext.Loader.loadScript({
                    ...
                    onLoad  : function() {
                        ...
                        Ext.require('APlan.locale.' + cls, function () {
