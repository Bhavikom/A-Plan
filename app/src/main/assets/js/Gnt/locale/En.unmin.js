Ext.define('Gnt.locale.En', {
    ...
    l10n      : {
        ...
        "Gnt.column.Text1": {text: "Text1"},
        "Gnt.column.Text2": {text: "Text2"},
        "Gnt.column.Text3": {text: "Text3"},
        "Gnt.column.Text4": {text: "Text4"},
        "Gnt.column.Text5": {text: "Text5"},
        "Gnt.column.Text6": {text: "Text6"},
        "Gnt.column.Text7": {text: "Text7"},
        "Gnt.column.Text8": {text: "Text8"},
        "Gnt.column.Text9": {text: "Text9"},
        "Gnt.column.Text10": {text: "Text10"},
        "Gnt.column.Number1": {text: "Number1"},
        "Gnt.column.Number2": {text: "Number2"},
        "Gnt.column.Number3": {text: "Number3"},
        "Gnt.column.Number4": {text: "Number4"},
        "Gnt.column.Number5": {text: "Number5"},
        "Gnt.column.Number6": {text: "Number6"},
        "Gnt.column.Number7": {text: "Number7"},
        "Gnt.column.Number8": {text: "Number8"},
        "Gnt.column.Number9": {text: "Number9"},
        "Gnt.column.Number10": {text: "Number10"},
        "Gnt.column.ClientName": {text: "Client"},
        "Gnt.column.ResponsiblePersonName": {text: "Responsible"},
        "Gnt.column.Priority": {text: "Responsible"},
        'Gnt.field.Milestone' : {
            yes : 'Yes',
            no  : 'No'
        },
