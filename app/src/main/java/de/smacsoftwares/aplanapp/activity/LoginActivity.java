...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void initControl() {
        ...
        //imgBack.setOnTouchListener(new CustomTouchListenerDate());
    ...
    private void getAuthenticateDetails() {
        try {
            ...
            RequestBody AppVersion = RequestBody.create(MediaType.parse("text/plain"), GlobalClass.getAppversion(activity));
...
//                                this will call getUserProfile service and navigate to dashboard
                            ...
                            if(preferences.get404Count() > 3){
                                ...
                                if(GlobalClass.isTablet(activity)){
                                    startActivity(new Intent(activity,AdminSplashActivity.class));
                                    finish();
                                }
                                else{
                                    startActivity(new Intent(activity,AdminSplashActivityForMobile.class));
                                    finish();
                                }
                            }
                        }
            ...
            LogApp.e("","exception while "+e.toString());
        }
    }
    ...
    public void onBackPressed() {
        if (!GlobalClass.isTablet(this)) {
            ...
            startActivity(new Intent(activity,GetUrlMobileActivity.class));
            finish();
        }
        else {
            //preferences.clearAdminshow();
            startActivity(new Intent(activity,GetUrlActivity.class));
            finish();
        }
