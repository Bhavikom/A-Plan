...
public class AdminSplashActivity extends Activity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            case R.id.btn_send:
                if (GlobalClass.isNetworkAvailable(activity)) {
                    if (checkValidation()) {
                        /// call get user detail service here
    ...
    private void getUserDetailsservice() {
        try {
            ...
            progressDialog = new ProgressDialog(AdminSplashActivity.this);
                    ...
                    try {
                        ...
                        if (header.get(getResources().getString(R.string.x_status)) != null &&
                            ...
                            if (status.equalsIgnoreCase("0")) {
                                ...
                                Intent intent = new Intent(AdminSplashActivity.this, SelectLoginType.class);
