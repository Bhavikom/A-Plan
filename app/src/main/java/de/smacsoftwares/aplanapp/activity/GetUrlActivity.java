...
public class GetUrlActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(GlobalClass.getScreenOrientation(this) ==1){
            ...
            screenHeight = (int) (metrics.widthPixels * 0.85);
            DisplayMetrics metrics2 = getResources().getDisplayMetrics();
        }
        else {
            screenWidth = (int) (metrics.widthPixels * 0.55);
            screenHeight = (int) (metrics.widthPixels * 0.55);
            DisplayMetrics metrics2 = getResources().getDisplayMetrics();
        }
        ...
        textViewBack.setOnTouchListener(new CustomTouchListenerDate());
    ...
    public void onClickBack(){
        //startActivity(new Intent(GetUrlActivity.this,SelectLoginType.class));
        finish();
    }
    ...
    public void setLanguage(String language) {
        ...
        textViewBack.setText(getString(R.string.Cancel));
    ...
    private void getUrlService() {
        try {
            progressDialog = new ProgressDialog(GetUrlActivity.this);
                            ...
                            if(response.body() != null) {
                                ...
                                if (status.equalsIgnoreCase("0")) {
                                    ...
                                    if (GlobalClass.isTablet(activity)) {
                                        Intent i = new Intent(GetUrlActivity.this,LoginActivity.class);
                                        i.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
                                        startActivity(i);
                                        //startActivity(new Intent(GetUrlActivity.this, LoginActivity.class));
                                        finish();
                                    } else {
                                        Intent i = new Intent(GetUrlActivity.this, LoginMobileActivity.class);
                                        i.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
                                        startActivity(i);
                                        //startActivity(new Intent(GetUrlActivity.this, LoginActivity.class));
                                        finish();
                ...
                public void onFailure(Call<String> call, Throwable t) {
                    ...
                    if(t instanceof UnknownHostException){
                        ...
                        if(preferences.get404Count() > 3){
                            ...
                            if(GlobalClass.isTablet(activity)){
                                Intent i = new Intent(GetUrlActivity.this, AdminSplashActivity.class);
                                i.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
                                startActivity(i);
                                //startActivity(new Intent(GetUrlActivity.this, LoginActivity.class));
                                finish();
                                ...
                                Intent i = new Intent(GetUrlActivity.this, AdminSplashActivityForMobile.class);
                                i.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY);
                                startActivity(i);
                                //startActivity(new Intent(GetUrlActivity.this, LoginActivity.class));
                                finish();
        ...
        public boolean onTouch(View v, MotionEvent motionEvent) {
            switch (motionEvent.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    textViewBack.setTextColor(getResources().getColor(R.color.grey_dashboard));
                    //white
                    break;
                case MotionEvent.ACTION_CANCEL:
                case MotionEvent.ACTION_UP:
                    textViewBack.setTextColor(getResources().getColor(R.color.black_color)); //black
                    break;
            }
            return false;
        }
