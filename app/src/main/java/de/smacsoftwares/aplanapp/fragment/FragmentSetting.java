...
public class FragmentSetting extends Fragment implements FragmentProfile.IntefaceChangepass,
        AdapterView.OnItemClickListener,InterfaceChangeLanguageSetting
{
    ...
    public void initControl()
    {
       ...
       /* getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        listviewDrawerItem.removeFooterView(footerViewBlank);
    ...
    private void signOutService(final int pos)
    {
        try
        {
