 ...
 */
public class FragmentTutorial7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        linearMain=(LinearLayout)rootView.findViewById(R.id.linear_tutorila7_main);
        GlobalClass.setupTypeface(linearMain, GlobalClass.fontLight);
        textViewTitle = (TextView)rootView.findViewById(R.id.lable_title7);
