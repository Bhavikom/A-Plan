package de.smacsoftwares.aplanapp.caldroid;
...
public class CaldroidFragment extends DialogFragment {
    ...
    private Formatter monthYearFormatter = new Formatter(
            monthYearStringBuilder, Locale.ENGLISH);
    ...
    private TextView monthTitleTextView,textviewDone;
    ...
    protected void refreshMonthTitleTextView() {
        ...
        monthTitleTextView.setText(monthTitle.toUpperCase(Locale.ENGLISH));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        textviewDone.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                caldroidListener.onDoneClicked();
            }
        });
        imgDatePicker.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                caldroidListener.onDatePickerClicked();
            }
        });
    ...
    public void visibleDateIcon(boolean flag){
        if(flag){
            imgDatePicker.setVisibility(View.VISIBLE);
        }
        else {
            imgDatePicker.setVisibility(View.GONE);
        }
    }
	@Override
    ...
    protected ArrayList<String> getDaysOfWeek() {
        ...
        SimpleDateFormat fmt = new SimpleDateFormat("EEE", Locale.ENGLISH);
