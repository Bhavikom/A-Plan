 ...
 */
// this adapter is for setting date spinner in dashboard
public class DateFilterDialogAdapter extends BaseAdapter {
    Context context;
    List<FilterModelClass> arraylist;
    public DateFilterDialogAdapter(Context context, List<FilterModelClass> items) {
