 ...
 */
// this adapter is for resource spinner in text filter fragment
public class ResourceAdapter extends BaseAdapter {
    Context context;
    ArrayList<ResourceDataSetClass> arraylist;
    public ResourceAdapter(Context context, ArrayList<ResourceDataSetClass> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textview.setText(arraylist.get(position).getResourceName());
        holder.linearMain = (RelativeLayout)convertView.findViewById(R.id.relative_client_spinner_main);
