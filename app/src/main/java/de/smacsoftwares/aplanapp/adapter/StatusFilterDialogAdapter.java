 ...
 */
// this adapter is for status dialog listview in project fragment
public class StatusFilterDialogAdapter extends BaseAdapter {
    Context context;
    List<FilterModelClass> arraylist;
    public StatusFilterDialogAdapter(Context context, List<FilterModelClass> items) {
